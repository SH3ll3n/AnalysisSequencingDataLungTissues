...
# In this case we removing rows of the DESeqDataSet that have no counts, or only a single count across all samples
nrow(result)
...
# Other types of plot that you can use (MDS plot and t-SNE plot)
...
# log2foldchange, is - or +, it's important to have an absolute big value
